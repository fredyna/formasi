...
<div class="login-box" style="margin-top:10%;">
  ...
  <div class="login-box-body">
    ...
    <p class="login-box-msg">Silahkan Isi Data Alumni</p>
    ...
    ?>
      ...
      <input type="hidden" name="kategori" value="2" class="form-control">

      <div class="form-group">
        <label for="nama" class="col-sm-3 control-label">Nama</label>
        <div class="col-sm-9">
          <input type="text" name="nama" value="<?php echo set_value('nama');?>" class="form-control" placeholder="Masukan nama lengkap">
      ...
      <div class="form-group">
        ...
        <div class="col-sm-9">
          <input type="text" name="pekerjaan" value="<?php echo set_value('pekerjaan');?>" class="form-control" placeholder="Isikan pekerjaan...">
      ...
      <div class="form-group">
        ...
        <div class="col-sm-9">
          <textarea name="alamat" class="form-control" placeholder="isikan alamat"><?php echo set_value('alamat');?></textarea>
      ...
      <div class="form-group">
        <div class="col-sm-offset-3 col-sm-4">
          <button type="submit" name="submit" value="submit" class="btn btn-success"><i class="fa fa-send"></i> Kirim Data</button>
        </div>
      </div>
    </form>
    <br /><!-- 

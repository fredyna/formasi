...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      <li><a href="<?php echo base_url('kas');?>"><i class="fa fa-money"></i> Add Kas</a></li>
      ...
      <div class="box box-success">
          ...
          <div class="box-body">
            ...
            <?php
                ...
                echo form_open('kas/addData/',$name);
            ?>

              <div class="form-group">
                <label for="kas" class="col-sm-3 control-label">Besar Kas</label>
                <div class="col-sm-8">
                  <input type="number" name="kas" value="<?php echo set_value('kas');?>" class="form-control" placeholder="Besar Kas" required>

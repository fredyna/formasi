  ...
  <section class="content container-fluid">
    ...
    <div class="col-md-12">
      <div class="box box-success">
          ...
          <!-- /.box-header -->
          <div class="box-body">
             <?php if($this->session->flashdata('info-role')){ ?>
                <div class="alert alert-warning alert-dismissable">
                    <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                    <?php echo $this->session->flashdata('info-role'); ?>
                </div>
            <?php } ?>
            ...
            <?php
                ...
                echo form_open('member/updateRole/'.$member->id,$name);
            ?>
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <select name="role" class="form-control">
                    ...
                    <?php if($groups!=null){
                        foreach($groups as $g){ ?>
                          <option value="<?php echo $g->id;?>" <?php echo $g->id==$member_group ? 'selected':''?>><?php echo $g->name;?></option>
                    <?php  }
                    }?>
                  </select>
      ...
      <div class="box box-success">
          ...
          <div class="box-body">
            ...
            <?php
                ...
                echo form_open('member/updateMember/'.$member->id,$name);
            ?>
      ...
      <div class="box box-success">
          ...
          <div class="box-body">
            ...
            <?php
                ...
                echo form_open('member/updatePassword/'.$member->id,$name);
            ?>

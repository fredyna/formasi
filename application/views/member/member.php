    ...
    <div class="col-md-12">
      <div class="box box-success">
          ...
          <div class="box-body">
            ...
            <a href="<?php echo base_url('member/addMember');?>" class="btn btn-sm btn-success"><i class="fa fa-plus"></i> Add Data</a> 
            <br /><br />
            ...
            <?php } ?>
                  ...
                  <tr>
                      ...
                      <td style="text-align: center;">
                          ...
                          <?php } ?>
                          <a class='btn btn-info btn-xs' href="<?php echo base_url('member/editMember/'.$m->id); ?>"><i class="glyphicon glyphicon-edit"></i> </a>
                          <a class='btn btn-danger btn-xs' href="#" onclick="functionDelete('<?php echo base_url('member/deleteMember/'.$m->id); ?>')"><i class="glyphicon glyphicon-trash"></i> </a>
